...
- **Hanna Meyer**. Maintainer, author.

- **Carles Milà**. Author.

- **Marvin Ludwig**. Author.

- **Jan Linnenbrink**. Author.

- **Fabian Schumacher**. Author.

- **Philipp Otto**. Contributor.

- **Chris Reudenbach**. Contributor.
...
1.1.0, <https://github.com/HannaMeyer/CAST>.
