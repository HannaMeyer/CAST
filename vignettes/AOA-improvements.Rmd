...
This vignette goes over recent changes (November 2021) of the Area of Applicability (AOA). The main change is the split of the AOA function into `trainDI` and `aoa`. This was mainly done for easier future developments and parallel computations. But the update also includes some new visualization methods for a better interpretation of the AOA.
...
grid.arrange(spplot(response,col.regions=viridis(100),
            ...
            spplot(AOA_random$predictionAOA$DI,col.regions=viridis(100),main="DI"),
  spplot(prediction_random, col.regions=viridis(100),main="prediction for AOA \n(random CV error applies)")+
         spplot(AOA_random$predictionAOA$AOA,col.regions=c("grey","transparent")),
ncol=3)
```
