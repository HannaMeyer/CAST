...
# use random CV:
dist_clstr_rCV <- plot_geodist(pts_clustered,predictors_global,distance = "feature", variables = c("bio2","bio5","bio12","bio15","bio19"),cvfolds = randomfolds,scale=T, showPlot=FALSE)

# use spatial CV:
dist_clstr_sCV <- plot_geodist(pts_clustered,predictors_global,distance = "feature", variables = c("bio2","bio5","bio12","bio15","bio19"),cvfolds = spatialfolds$indexOut, scale =TRUE, showPlot=FALSE)
