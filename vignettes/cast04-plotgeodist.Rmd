...
samplesize <- 500 # how many samples will be used?
nparents <- 20 #For clustered samples: How many clusters? 
radius <- 7 # For clustered samples: What is the radius of a cluster?
NNDM <- FALSE ## Show Results for NNDM as well? See explanations further below.
# Note that NNDM takes a while, especially for large samplesize.
# install via remotes::install_github("carlesmila/NNDM")
...
Note: To run these examples, install the NNDM package first via remotes::install_github("carlesmila/NNDM") and change NNDM <- FALSE to NNDM y- TRUE in the beginnig of this script.
