...
NNDM <- TRUE ## Show Results for NNDM as well? See explanations further below.
...
Since NNDM is a variation of leave-one-out CV it takes quite long. 
Change NNDM=TRUE to NNDM=FALSE in the beginning of this script to avoid running it!
`
