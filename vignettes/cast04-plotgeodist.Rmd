...
nndmfolds_clstr <- nndm(pts_clustered, modeldomain=co.ee, sampling = "Fibonacci",samplesize = 2000)
dist_clstr <- plot_geodist(pts_clustered,co.ee,
                           sampling = "Fibonacci",
...
nndmfolds_rand <- nndm(pts_random_co,  modeldomain=co.ee, sampling = "Fibonacci",samplesize = 2000)
