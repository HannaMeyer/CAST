...
```{r, message = FALSE, warning = FALSE}
TDI = trainDI(model)
class(AOA$parameters)
class(TDI)
names(TDI)
print(TDI)
```

Plotting a trainDI object displays the distribution of the DI of the training data together with the lower and upper AOA thresholds (vertical lines). Plotting the aoa object, also displays the DI of new data in the plot.
