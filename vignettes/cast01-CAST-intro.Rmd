...
Based on the trained model we can make spatial predictions of soil moisture. To do this we load a RasterStack that contains spatial data of all predictor variables for the 25th of March 2012 (as an example). We then apply the trained model on this data set.
...
Note that several suggestions of spatial CV exist. What we call LLO here is just a simple example. See references in Meyer and Pebesma (2022) for some examples.
