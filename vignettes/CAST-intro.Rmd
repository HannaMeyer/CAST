...
Still it is required to analyse if the model can be applied to the entire study area of if there are lcoations that are very different in their predictor properties to what the model has learned from. See more details in the vignette on the Area of applicability and 
...
AOA_random <- AOA_random$predictionAOA
