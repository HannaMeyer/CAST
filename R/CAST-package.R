...
#' It includes the newly suggested 'Nearest neighbor distance matching' cross-validation to estimate the prediction performance
#' of spatial and spatial-temporal models and allows for spatial variable selection to selects suitable predictor variables
